...
try:
    ...
    pid = open('/Users/mjacobs/git/bebop/pid').read()
    ...
    if len(lines) > 1:
        ...
        # Delete pid file
        os.remove('/Users/mjacobs/git/bebop/pid')
except IOError:
    pass
...
if running:
    ...
    pid = os.fork()
    if pid == 0:
        os.execl('/usr/local/bin/python2.4', '/usr/local/bin/python2.4', '/Users/mjacobs/git/bebop/site.py')
    else:
        open('/Users/mjacobs/git/bebop/pid', 'w').write(str(pid))
